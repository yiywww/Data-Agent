...
public class AuthServiceImpl implements AuthService {
    ...
    public Boolean register(RegisterRequest request) {
        ...
        BusinessException.throwIf(
                sysUsersService
                        .exists(new LambdaQueryWrapper<SysUsers>().eq(SysUsers::getUsername, request.getUsername())),
                ResponseConstant.PARAM_ERROR,
                ResponseConstant.EMAIL_OR_USERNAME_EXISTS_MESSAGE);
        BusinessException.throwIf(
                sysUsersService.exists(new LambdaQueryWrapper<SysUsers>().eq(SysUsers::getEmail, request.getEmail())),
                ResponseConstant.PARAM_ERROR,
                ResponseConstant.EMAIL_OR_USERNAME_EXISTS_MESSAGE);
